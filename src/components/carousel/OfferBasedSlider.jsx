      ...
      <Carousel>
        <Carousel.Item>
          <div className="row">
            ...
            <div className="col-6 col-md-4 col-lg-2">
              <img
                src="https://assets.myntassets.com/w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/8/3/a9734bdc-8054-4806-8ab4-748d7dfdfe411691066316796-unnamed---2023-08-03T180830.165.png"
                alt="Offer Collection"
                className="img-fluid"
              />
            </div>
        ...
        <Carousel.Item>
          <div className="row">
            ...
            <div className="col-6 col-md-4 col-lg-2">
              <img
                src="https://assets.myntassets.com/w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/8/4/6366f7f4-3942-4cbc-af0d-3b63c0f9add71691142685532-image_png45885503.png"
                alt="Offer Collection"
                className="img-fluid"
              />
            </div>
...
export default OfferBasedSlider;
