...
const KidsListingPage = () => {
  ...
  const filteredProducts = productsList.filter((product) => {
    ...
    const isKidsProduct = product.gender === "BOYS" || product.gender === "GIRLS";

    return matchesSearchTerm && matchesCategory && matchesRating && isKidsProduct;
  });
...
export default KidsListingPage;
